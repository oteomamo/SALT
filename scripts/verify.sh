...
#
# Areas: chat, engine, dedup, keys, evict, incr, tail, text, scope, turns,
...
case "${1:-}" in
  chat|engine|dedup|keys|evict|incr|tail|text|scope|turns|agents|mcp|pdf|docs|smoke|vllm|serve|all)
    "area_$1" ;;
  *)
